			...
			{:else}
				<div class="flex-1 flex items-center justify-center">
					<div class="text-center">
						...
						<h2 class="text-xl font-semibold text-gray-900 mb-2">Select projects to view</h2>
						<p class="text-gray-600">Click projects in the sidebar to open them in columns</p>
					</div>
				</div>
			{/if}
		</div>
