		...
		>
			{#each items as item, index (index)}
				...
				{:else if item.submenu}
					...
					>
						<button
							class="flex items-center w-full px-2 py-1.5 text-sm rounded hover:bg-gray-100 transition-colors"
							type="button"
						>
							{#if item.icon}
						...
						{#if openSubmenuIndex === index}
							<div
								class="absolute left-full top-0 ml-1 min-w-[12rem] overflow-hidden rounded-md border border-gray-200 bg-white p-1 shadow-lg"
							>
