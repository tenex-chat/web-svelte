...
<div
	class="detached-window fixed bg-white rounded-lg shadow-2xl border border-gray-300 flex flex-col overflow-hidden"
	style="
...
>
	<!-- Window Header -->
	<div
		class="window-header flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-gray-50"
